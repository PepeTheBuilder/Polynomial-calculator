...
public class Polinome {
    ...
    public DivisionResult division ( HashMap<Integer, Float> poly1,  HashMap<Integer, Float> poly2){
    ...
    public  HashMap<Integer, Float> derivate( HashMap<Integer, Float> poly1){
    ...
    public  HashMap<Integer, Float> derivate(){
        return derivate(this.getPolinome());
    }

    public  HashMap<Integer, Float> integrate( HashMap<Integer, Float> poly1){
        HashMap<Integer, Float> result =  new HashMap<Integer, Float>();
        if(isZeroPolynomial(poly1)){
            return result;
        }
    ...
    public  HashMap<Integer, Float> integrate(){
        return integrate(this.getPolinome());
    }

    public  HashMap<Integer, Float> multiplyPolynomials( HashMap<Integer, Float> poly1,  HashMap<Integer, Float> poly2){
        HashMap<Integer, Float> result = new HashMap<Integer, Float>();
    ...
    public  HashMap<Integer, Float> multiplyPolynomials(HashMap<Integer, Float> poly2){
        return multiplyPolynomials(this.polynomial,poly2);
    }
    public  HashMap<Integer, Float> multiplyPolynomials(Polinome poly2){
        return multiplyPolynomials(this.polynomial,poly2.getPolinome());
    }

    public  HashMap<Integer, Float> addPolynomials( HashMap<Integer, Float> poly1,  HashMap<Integer, Float> poly2) {
    ...
    public  HashMap<Integer, Float> addPolynomials(HashMap<Integer, Float> poly2){
        return addPolynomials(this.polynomial,poly2);
    }
    public  HashMap<Integer, Float> addPolynomials(Polinome poly2){
    ...
    public  HashMap<Integer, Float> subPolynomials(HashMap<Integer, Float> poly1, HashMap<Integer, Float> poly2) {
...
/*        for (Map.Entry<Integer, Float> term1 : poly1.entrySet()) {
    ...
    public  HashMap<Integer, Float> subPolynomials(HashMap<Integer, Float> poly2){
        return subPolynomials(this.polynomial,poly2);
    }
    public  HashMap<Integer, Float> subPolynomials(Polinome poly2){
